...
import "./EtherPhunksMarketV2_1.sol";

contract EtherPhunksMarketV2_2 is EtherPhunksMarketV2_1 {
     ...
     */
    function initializeV2_2(uint256 _newVersion) public reinitializer(4) {
